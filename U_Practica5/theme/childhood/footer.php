<div class="question">
    ...
    echo $custom_logo__url[0]; ?>" alt="мир детства" class="footer__logo-img">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('link_instagram', 35); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_facebook', 35); ?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('link_youtube', 35); ?>" class="footer__social-item">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            ...
                            <div class="footer__contacts-item">
                                ...
                                <address><?php the_field('address_street_company', 35); ?>, <?php the_field('address_number_company', 35); ?><br>
                                <?php the_field('address_sity_company', 35); ?>, <?php the_field('address_country_company', 35); ?>, <?php the_field('address_index_company', 35); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
