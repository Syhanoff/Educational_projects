                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:<?php the_field('mail_first', 35); ?>" class="header__contacts-mail"><?php the_field('mail_first', 35); ?></a>
                            </div>
                            <div class="header__contacts-item">
                            ...
                            <div class="header__contacts-item">
                                ...
                                <address><?php the_field('address_street_company', 35); echo ", "; the_field('address_number_company', 35); ?><br>
                                <?php the_field('address_sity_company', 35); echo ", "; the_field('address_country_company', 35); echo ", "; the_field('address_index_company', 35); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
