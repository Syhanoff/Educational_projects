              ...
              <div class="container">
                    <div class="row">
                      <div class="col-lg-7 offset-1">
                          <h2 style="<?php
                                      $field = get_field('slider_title_color');
                                      if ($field == 'light') {
                                      ?>
                                      color: #fff;
                                      <?php
                          ...
                          if ($field == 'on') {
                          ?>
                          <a href="<?php the_field('slider_btn_link'); ?>" class="button">Узнать больше</a>
                          <?php
                          } ?>
                      </div>
                    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                <h1 class="title underlined"><?php the_field('about_titl'); ?> </h1>
                <div class="about__text">
                <?php the_field('about_txt'); ?>
                </div>
                <a href="<?php echo get_permalink(208); ?>" class="button">Узнать больше</a>
            </div>
        </div>
    </div>
</div>
