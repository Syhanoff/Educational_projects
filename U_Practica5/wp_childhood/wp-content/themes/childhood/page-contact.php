  ...
  <div class="container">
      <div class="row">
          <div class="col-lg-6">
              <div class="contacts__descr underlined">
                  <p><?php the_field('address_way_company', 35); ?></p>
                  <br> <br>
                  <p>по адресу <?php the_field('address_street_company', 35); ?>, <?php the_field('address_number_company', 35); ?></p>
              </div>
          </div>
          <div class="col-lg-6">
              <div class="contacts__map">
                  <?php echo do_shortcode('[yamap center="55.7568,37.6434" height="100%" controls="zoomControl" zoom="11" type="yandex#map" mobiledrag="0"][yaplacemark  name="Новая метка" coord="55.639756, 37.506307" icon="islands#blueCircleIcon" color="#e30e7f" url="https://www.otkrovenie-scena.ru/"][/yamap]'); ?>
              </div>
          </div>
      </div>
      <div class="row">
          <div class="col-md-6">
              <div class="title contacts__minititle"><?php the_field('contact_subtitle'); ?></div>
                  ...
                  <div class="contacts__phones">
                      <div class="contacts__phoneblock">
                          ...
                          <div class="contacts__phonewrap">
                              ...
                              <a href="tel:+<?php the_field('phone_first', 35); ?>">+<?php the_field('phone_first', 35); ?></a>
                          </div>
                      </div>
                      <div class="contacts__phoneblock">
                          Телефон №2
                          <div class="contacts__phonewrap">
                              ...
                              <a href="tel:+<?php the_field('phone_second', 35); ?>">+<?php the_field('phone_second', 35); ?></a>
                          </div>
                      </div>
                  </div>
                  <div class="contacts__mail">
                      Или напишите нам на почту
                      <a href="mailto:<?php the_field('mail_first', 35); ?>"><?php the_field('mail_first', 35); ?></a>
                  </div>
              </div>
          </div>
          <div class="col-md-6">
      ...
      <div class="row mt70">
        <div class="col-lg-8 offset-lg-2">
            <div class="title"><?php the_field('testimonals_title'); ?></div>
                    ...
                    foreach( $my_posts as $post ){
                        ...
                        <li class="glide__slide">
                          <div class="feedslider__title">
                              <?php the_field('reviews_autor'); ?>
                          </div>
                          <div class="feedslider__text">
                              <?php the_field('reviews_txt'); ?>
                        </li>
                        <?php
                    }
                    wp_reset_postdata();
